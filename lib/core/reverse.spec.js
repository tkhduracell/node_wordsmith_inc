...
describe('Reverse module', () => {
  ...
  describe('"paragraph"', () => {
    ...
    it('should give a paragraph with reversed words', () => {
        expect(reverse.paragraph('The red fox crosses the ice, intent on none of my business.')).to.be.eql('ehT der xof sessorc eht eci, tnetni no enon fo ym ssenisub.')
      })
  })
})
